...
const Player = () => {
    const {seekBar, seekBg, playStatus, play, pause, track, time, previous, next, seekSong} = useContext(SpotifyContext);
  return (
    <div className='h-[10%] bg-black flex justify-between items-center text-white px-4'>
        <div className='hidden lg:flex items-center gap-4'>
            <img className='w-9' src={track.image} alt="" />
            <div>
                <p>{track.name}</p>
        ...
        <div className='flex flex-col items-center gap-1 m-auto'>
            <div className='flex gap-4'>
                ...
                <img src={!playStatus ? assets.play_icon : assets.pause_icon} alt="" className='w-4 cursor-pointer' onClick={!playStatus ? play : pause}/>
