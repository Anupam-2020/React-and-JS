    ...
    <div className='border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100'>
      ...
      <div className='flex gap-12 sm:gap-12 flex-col sm:flex-row'>
        ...
        <div className='flex-1 flex flex-col-reverse gap-3 sm:flex-row'>
          <div className='flex sm:flex-col overflow-x-auto sm:overflow-y-scroll justify-between sm:justify-normal sm:w-[18.7%] w-full'>
            {productData?.image?.map((product, index) => (
               <img onClick={() => setImage(product)} src={product} alt="" key={index} className='w-[24%] sm:w-full sm:mb-3 flex-shrink-0 cursor-pointer'/>
            ))}
          </div>
          <div className='w-fill sm:w-[80%]'>
        ...
        <div className='flex-1'>
          ...
          <button onClick={() => addToCart(productData._id, size)} className='border py-2 px-4 bg-orange-500 text-white active:bg-orange-700 cursor-pointer hover:bg-orange-600'>ADD TO CART</button>
