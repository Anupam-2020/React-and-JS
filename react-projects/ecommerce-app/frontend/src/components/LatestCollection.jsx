  ...
  return (
    <div className='my-10'>
        <div className='text-center py-8 text-3xl'>
            ...
            <p className='w-3/4 m-auto text-xs sm:text-sm md:text-base text-gray-600'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Non vero deleniti, voluptatum laudantium cumque quas! Consectetur</p>
        </div>
        {/* Rendering Products */}
